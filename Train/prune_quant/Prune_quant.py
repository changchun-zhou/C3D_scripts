...
sys.path.append("./scripts/Train/prune_quant/")
import train_model
import logging
import argparse
...
postquant_pth = 'Extract/prune_high_ele/run/run_4/models/C3D-ucf101_epoch-99.pth.tar' 
device = torch.device(args.device)
print("Device being used:", device)

# Pruning 30 epoches
nEpochs =71 # epoch 49  # Number of epochs for training
resume_epoch = 0  # Default is 0, change if want to resume
useTest = True # See evolution of the test set when training
nTestInterval = 5 # Run on test set every nTestInterval epochs
save_epoch = 10 # Store a model every snapshot epochs
...
msglogger.info('*'*45+'command line :',sys.argv)
...
c3d = C3D_model.C3D(num_classes = 101)
