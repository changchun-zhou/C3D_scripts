...
def load_checkpoint_self(model, chkpt_file, optimizer=None,
                    model_device=None, lean_checkpoint=False, strict=False, file=None):
    ...
    if 'compression_sched' in checkpoint:
        ...
        file, compression_scheduler,resumed_epoch=1)
    ...
    # for k in model.state_dict():
    #     print('********** model.state_dict()***********',k )
    print('**** normalize_dataparallel_keys', normalize_dataparallel_keys)
    # if normalize_dataparallel_keys:
